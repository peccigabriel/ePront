  ...
  async function handleLogon(e) {
    ...
    if (id === '') {
      ...
      try {
        ...
        localStorage.setItem('idMed', id);
        localStorage.setItem('nameMed', response.data.nameMed);
        localStorage.setItem('crmMed', response.data.crmMed);
        ...
        if (error.message === "Network Error") {
          ...
          Swal.fire({
            icon: 'warning',
            title: 'Oops...',
            text: 'Nenhum médico encontrado com esse ID.',
          });
        }
      }
    }
